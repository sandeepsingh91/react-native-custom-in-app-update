...
import com.google.android.play.core.appupdate.InstallStateUpdatedListener;
...
public class CustomInAppUpdateModule extends ReactContextBaseJavaModule implements InstallStateUpdatedListener, LifecycleEventListener {
    ...
    CustomInAppUpdateModule(ReactApplicationContext context) {
        super(context);
